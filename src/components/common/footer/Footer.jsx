...
const Footer = () => {
  return (
    <>
      ...
      <footer>
        <div className='container padding'>
          <div className='box logo'>
            ...
            <a href="https://www.facebook.com/AlokTechUniverse?mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer">
      ...
      <div className='legal'>
        <p>
          Copyright ©2024 All rights reserved |  <i className='fa fa-heart'></i> by Alok Tech
        </p>
      </div>
    </>
  )
